...
class UsersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ModelsUser>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ModelsUser>>> usersGet({ 
    ...
    BuiltList<ModelsUser>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ModelsUser)]),
      ) as BuiltList<ModelsUser>;
    ...
    return Response<BuiltList<ModelsUser>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> usersIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ModelsUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelsUser>> usersIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [ModelsUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelsUser>> usersIdPut({ 
    required String id,
    ...
    try {
      const _type = FullType(HandlersUpdateUserRequest);
  ...
  /// Returns a [Future] containing a [Response] with a [ModelsUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelsUser>> usersMeDefaultHomePut({ 
    required HandlersSetDefaultHomeRequest payload,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/me/default-home';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(HandlersSetDefaultHomeRequest);
  ...
  /// Returns a [Future] containing a [Response] with a [ModelsUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelsUser>> usersMeGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
