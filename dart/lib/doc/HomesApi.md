...
# **homesGet**
> Map<String, List<ModelsHome>> homesGet()
...
[**Map<String, List<ModelsHome>>**](List.md)
...
final api_instance = HomesApi();
final id = id_example; // String | Home ID

try {
    final result = api_instance.homesIdDelete(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.homesIdGet(id);
    print(result);
} catch (e) {
...
final api_instance = HomesApi();
final id = id_example; // String | Home ID
final home = HandlersCreateHomeRequest(); // HandlersCreateHomeRequest | Home payload

try {
    final result = api_instance.homesIdPut(id, home);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.homesPost(home);
    print(result);
} catch (e) {
